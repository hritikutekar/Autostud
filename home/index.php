...
<body class="quickSectionActive">0
        ...
        <main class="contentArea">
            <div class="contentAreaInner clearfix no-pad-left no-pad-right">
                <header class="page-header text-center extra-top-pad">
                    <h1>HAVE <span>ANY</span> PROBLEM?</h1>
                    <strong>Let teachers help you to solve your problem <br><a href="../post_question/">ask a question now</a></strong>
                </header>
                <div class="empty-graphics-div text-center">
                    <img src="../assets/img/graphicss2.png" alt="">
                </div>
                <div class="text-center">
                    <a href="../post_question/" class="btn btn-lg"><i class="fa fa-hashtag"></i>POST QUESTION</a>
                </div>
