    ...
    <div class="bodyWrap">
        ...
        <div class="optionsPanel">
            ...
            <div class="inner">
                ...
                <a href="view_attendance.php"><button class="btn-block btn">View Attendance</button></a><br>
                <a href="../../post_question"><button class="btn-block btn">Post Question</button></a><br>
                <a href="../../discussion/my_question.php"><button class="btn-block btn">My Questions</button></a><br>
