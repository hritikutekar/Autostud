...
<div class="bodyWrap">
    ...
    <div class="optionsPanel">
        ...
        <div class="inner">
            ...
            if ($row['MAN'] == '1') {
                echo '<a class="triggerSwap" href="man.php"><button class="btn-block btn">MAN</button></a><br>';
            }
            if ($row['STE'] == '1') {
                echo '<a class="triggerSwap" href="ste.php"><button class="btn-block btn">STE</button></a><br>';
            }
            if ($row['ESY'] == '1') {
                echo '<a class="triggerSwap" href="esy.php"><button class="btn-block btn">ESY</button></a><br>';
            }
    ...
    <main class="contentArea">
        <div class="contentAreaInner clearfix no-pad-left no-pad-right">
            <header class="page-header text-center extra-top-pad pad-long">
                <strong><span class="sub">MAN</span> (Management) <?php echo date("d/m/Y"); ?></strong><br><br>
                ...
                while ($row1 = $result1->fetch_assoc()) {
                    ...
                    echo '<div class="student-record aligncenter">
                              ...
                              <span class="present"><li>'.$row2['MAN'].'</li></span>
...
<script src="../../assets/js/take_man.js"></script>
