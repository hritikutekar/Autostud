...
<head>
    ...
    <title>AutoStud - Take Attendance</title>
    <!--========================================
    Meta
    ===========================================-->
    <meta charset="utf-8">
...
<div class="bodyWrap">
    ...
    <div class="optionsPanel">
        ...
        <div class="inner">
            ...
            if ($row['AJP'] == '1') {
                echo '<a href="ajp.php"><button class="btn-block btn">AJP</button></a><br>';
            }
            if ($row['MAN'] == '1') {
                echo '<a href="man.php"><button class="btn-block btn">MAN</button></a><br>';
            }
            if ($row['STE'] == '1') {
                echo '<a href="ste.php"><button class="btn-block btn">STE</button></a><br>';
            }
            if ($row['ESY'] == '1') {
                echo '<a href="esy.php"><button class="btn-block btn">ESY</button></a><br>';
            }
